...
for (l in 1:Iteration){
  ...
  #################### Parameters ####################
  pop <- read.csv("populationParameters_asym.txt", row.names = 1)
...
write_xlsx(Probability,"Probability_A41.xlsx")
write_xlsx(Length,"Length_A41.xlsx")
write_xlsx(Burden,"Burden_A41.xlsx")
